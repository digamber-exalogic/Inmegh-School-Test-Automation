package com.inmegh_school.utils.generic;
...
public class CommonUtils {
    ...
    public static WebDriver _driver = CreateBrowserDriver.createDriver("Firefox", "http://inmegh-local.herokuapp.com/users/sign_in");
    ...
    public void login(String uid, String pid)
	{
    	login = PageFactory.initElements(_driver, LoginPage.class);
    	login.login_inmegh(uid, pid);
